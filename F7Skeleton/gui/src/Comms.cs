...
namespace F7SkeletonNS {
    ...
    class F7SkeletonComms {
        ...
        public F7SkeletonComms()
        {
            List<string> ports = F7SkeletonComms.GetPortNames();
            if (ports.Count > 0)
            {
                newPort(ports[0]);
                this.Open();
        ...
        public F7SkeletonComms(string port)
        {
            newPort(port);
            this.Open();
        }
        ...
        public static List<string> GetPortNames()
        {
            ...
            List<ComPort> portExtraInfo = F7SkeletonComms.GetSerialPorts();
