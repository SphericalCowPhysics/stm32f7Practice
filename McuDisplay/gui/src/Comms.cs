...
namespace McuDisplayNS {
    ...
    class McuDisplayComms {
        ...
        public McuDisplayComms()
        {
            List<string> ports = McuDisplayComms.GetPortNames();
            if (ports.Count > 0)
            {
                newPort(ports[0]);
                this.Open();
        ...
        public McuDisplayComms(string port)
        {
            newPort(port);
            this.Open();
        }
        ...
        public static List<string> GetPortNames()
        {
            ...
            List<ComPort> portExtraInfo = McuDisplayComms.GetSerialPorts();
