...
namespace McuMotorNS {
    ...
    class McuMotorComms {
        ...
        public McuMotorComms()
        {
            List<string> ports = McuMotorComms.GetPortNames();
            if (ports.Count > 0)
            {
                newPort(ports[0]);
                this.Open();
        ...
        public McuMotorComms(string port)
        {
            newPort(port);
            this.Open();
        }
        ...
        public static List<string> GetPortNames()
        {
            ...
            List<ComPort> portExtraInfo = McuMotorComms.GetSerialPorts();
